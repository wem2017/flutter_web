...
import 'package:devswift2017/constants/assets.dart';
import 'package:devswift2017/constants/fonts.dart';
import 'package:devswift2017/constants/strings.dart';
import 'package:devswift2017/constants/text_styles.dart';
import 'package:devswift2017/models/education.dart';
import 'package:devswift2017/utils/screen/screen_utils.dart';
import 'package:devswift2017/widgets/responsive_widget.dart';
    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window.open(
                "https://www.linkedin.com/in/huynh-dung-128962198", "LinkedIn");
          },
          child: Image.network(
            Assets.linkedin,
            color: Color(0xFF45405B),
