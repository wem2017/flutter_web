define(['dart_sdk', 'packages/flutter_web/animation'], function(dart_sdk, packages__flutter_web__animation) {
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C0 = dart.const({
        ...
        column: 12,
        line: 30,
        file: "org-dartlang-app:///packages/devswift2017/widgets/responsive_widget.dart"
      });
    }
  });
  let C2;
  ...
  dart.setLibraryUri(responsive_widget.ResponsiveWidget, "package:devswift2017/widgets/responsive_widget.dart");
  ...
  dart.trackLibraries("packages/devswift2017/widgets/responsive_widget", {
    "package:devswift2017/widgets/responsive_widget.dart": responsive_widget
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["responsive_widget.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAGe;;;;;;IACA;;;;;;IACA;;;;;;yBAS0B;AACrC,YAAyC,cAAvB,AAAY,AAAK,0BAAd,OAAO,gBAAe;IAC7C;yBAEuC;AACrC,YAAyC,cAAvB,AAAY,AAAK,0BAAd,OAAO,gBAAe;IAC7C;0BAEwC;AACtC,YAAyC,AAAM,cAA7B,AAAY,AAAK,0BAAd,OAAO,gBAAe,OACL,aAAvB,AAAY,AAAK,0BAAd,OAAO,gBAAe;IAC1C;UAG0B;AACxB,YAAO,gDACI,SAAC,SAAS;;AACjB,cAAyB,aAArB,AAAY,WAAD,aAAY;AACzB,kBAAO;gBACF,KAAyB,aAArB,AAAY,WAAD,aAAY,QAA6B,aAArB,AAAY,WAAD,aAAY;AAC/D,iBAAO;yBAAa,OAAG;;AAEvB,kBAAO;0BAAY,OAAG;;;IAI9B;;;QAhCS;QACY;QACV;QACA;;IAFU;IACV;IACA;AACL,sEAAW,GAAG;;EAAC","file":"responsive_widget.ddc.js"}');
  // Exports:
  return {
